...
def artikel(request):
    ...
    url = 'http://localhost:8000/dashboard/api/artikel/list/3000fe32442a1b97cc03d31631c87ec4eae003c6e6467874fc10fc965b28287e'
    #basic auth
    user_login = "dinamita"
    user_password = "dinamita091200"
...
def artikel_post(request, x_api_key):
    ...
    if request.method == 'POST':
        ...
        if serializer.is_valid():
            ...
            'massages':'berhasil membuat data'
        }
            return Response(content)
        ...
        content = {
            ...
            'massages':'method tidak ditemukan'
        }
    return Response(content)
